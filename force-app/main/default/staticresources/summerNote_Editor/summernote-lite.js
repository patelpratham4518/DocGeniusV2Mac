...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote.lang, {
          'en-US': {
            ...
            custom : {                                              // DocGenius Chnages.... For ToolTips
              rowcolor : 'Table Row Color',
              bordercolor : 'Table Border COlor',
              cellcolor : 'Single Cell Color',
            }
          }
        });
        ...
        */
        ...
        var Handle_Handle = /*#__PURE__*/function () {
          ...
          Handle_createClass(Handle, [{
            ...
            value: function initialize() {
              ...
              this.$document.on('wheel', function (e) {
                _this2.update();
              });
            }
          }, {
        ...
        var Buttons_Buttons = /*#__PURE__*/function () {
          ...
          Buttons_createClass(Buttons, [{
            ...
            value: function colorPalette(className, tooltip, backColor, foreColor) {
              ...
              return this.ui.buttonGroup({
                ...
                children: [this.button({
                  ...
                  contents: this.ui.icon(this.options.icons.font),          // DocGenius Changes...
                  tooltip: tooltip,     
            ...
            key: "addfontResizerButtons",
            value: function addfontResizerButtons() {
              var _this5 = this;
            ...
            value: function updateCurrentStyle($container) {
              ...
              if (styleInfo['line-height']) {
                var lineHeight = parseFloat(styleInfo['line-height']).toFixed(1);
                $cont.find('.dropdown-line-height a').each(function (idx, item) {
                  var $item = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(item); // always compare with string to avoid creating another func.
                  var isChecked = $item.data('value') + '' === lineHeight + '';
                  // _this6.className = isChecked ? 'checked' : '';
                  $item.toggleClass('checked', isChecked);      // DocGenius Chhages... current Line Height Option not showwing checked..so We chnages code...
                });
              }
            }
          }, {
        ...
        // CONCATENATED MODULE: ./src/js/base/module/fontResizer.js
        function fontResizer_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

        function fontResizer_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

        function fontResizer_createClass(Constructor, protoProps, staticProps) { if (protoProps) fontResizer_defineProperties(Constructor.prototype, protoProps); if (staticProps) fontResizer_defineProperties(Constructor, staticProps); return Constructor; }
        ...
        var fontResizer_fontResizer = /*#__PURE__*/function () {
          function fontResizer(context) {
            var _this = this;

            fontResizer_classCallCheck(this, fontResizer);
          ...
          fontResizer_createClass(fontResizer, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
            ...
            value: function update(target) {
              ...
              var isInRow = target ? target.closest('td') : false;
              var isInHead = target ? target.closest('th') : false;
              var isCell = dom.isCell(target) || isInRow || isInHead;      //DocGenius Changes... before table popover will remin open if you add text in cell with new line.. now this issue is resolved...
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
          ...
          options: {
            ...
            modules: {
              ...
              'fontResizer': fontResizer_fontResizer,
            ...
            icons: {
              ...
              'rowcolor' : 'note-icon-font',                   // DocGenius Change... To add change custome icon for plugins...
              'cellcolor' : 'note-icon-font',                 // DocGenius Change... To add change custome icon for plugins...
              'bordercolor' : 'note-icon-font',               // DocGenius Change... To add change custome icon for plugins...
              'verticaltop' : 'note-icon-align-justify',               // DocGenius Change... To add change custome icon for plugins...
              'verticalmiddle' : 'note-icon-align-justify',               // DocGenius Change... To add change custome icon for plugins...
              'verticalbottom' : 'note-icon-align-justify',               // DocGenius Change... To add change custome icon for plugins...
              'verticalbaseline' : 'note-icon-align-justify',               // DocGenius Change... To add change custome icon for plugins...
            }
          }
        });
...
/* harmony default export */ var ui_TooltipUI = (TooltipUI_TooltipUI);
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(document).on('click', function (e) {
          if (!external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(e.target).closest('.note-btn-group').length) {
            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('.note-btn-group.open .note-btn.active').removeClass('active');    //docGenius Changes... To relive active state of bold,itali,etc text fromatting..
