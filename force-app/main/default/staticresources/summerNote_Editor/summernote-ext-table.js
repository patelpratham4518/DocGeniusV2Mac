(function (factory) {
    ...
    var JTablePlugin = function (context) {
        ...
        context.memo('button.jBackcolor', function () {
            return self.colorPalette('note-color-back', lang.jTable.cellcolor, self.color);
        });
        ...
        self.colorPalette = function (className, tooltip, callbackFnc) {
            return ui.buttonGroup({
                ...
                children : [
                    ui.button({
                        className: 'note-current-color-button note-recent-color dropdown-toggle setMaxWidth',       // DocGenius Changes...
                        contents : className == 'note-color-table-border' ? ui.icon(options.icons.bordercolor) : ui.icon(options.icons.cellcolor),
                        tooltip  : tooltip,
                        container: options.container,
                        data     : {
                            toggle: 'dropdown',
                        },
                        // DocGenius Changes... START ....
                        // click    : function (e) {
                        ...
                        items   : ([
                            '<div class="note-palette">',
                                ...
                                '<div>',
                                    ...
                                    lang.color.cpSelect,
                                    '</button>',
                                '<input type="color" id="backColorPicker" class="note-btn note-color-select-btn" value="' + '#ffffff' + '" data-event="backColorPalette">',
                                '</div>',
    ...
    $.extend(true, $.summernote.lang, {
        'en-US': {
            jTable: {
                ...
                cellcolor : 'Cell Color'              // DocGenius Changes.... to show tooltip.
            }
        },
        'ko-KR': {
            jTable: {
